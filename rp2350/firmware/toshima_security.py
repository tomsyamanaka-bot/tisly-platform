...
# デバウンス（ms）— VPS home-toshima-security-v1 と同期
DI_DEBOUNCE_MS = 100
# パトライト点滅周期（ms）
...
class ToshimaMainHouseController(ToshimaBaseController):
    """
...
class ToshimaDetachedController(ToshimaBaseController):
    """
