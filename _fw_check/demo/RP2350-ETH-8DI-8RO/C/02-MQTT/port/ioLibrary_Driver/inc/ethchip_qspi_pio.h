...
typedef struct net_spi_funcs** net_spi_handle_t;
#if   (_NETCHIP_ == W6300)
typedef struct net_spi_config
{
...
typedef struct net_spi_funcs {
    void (*close)(net_spi_handle_t funcs);
    void (*set_active)(net_spi_handle_t funcs);
    ...
    void (*reset)(net_spi_handle_t funcs);
} net_spi_funcs_t;
#else
     typedef struct net_spi_config {
         uint8_t data_in_pin;
