...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2481-neon-3d-pins";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2481-neon-3d-pins";
const PRIORITY_CACHE = "tisly-pwa-priority-v2481-neon-3d-pins";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2481-neon-3d-pins";
/* お客様ゾーンの互換トークン
