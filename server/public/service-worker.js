...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2424-qnap-env-first";
const OFFLINE_CACHE = "tisly-pwa-shell-v2424-qnap-env-first";
const PRIORITY_CACHE = "tisly-pwa-priority-v2424-qnap-env-first";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2424-qnap-env-first";
const ICON_V = "?v=2004";
