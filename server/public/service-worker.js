...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2511-text-to-3d-prompt";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2511-text-to-3d-prompt";
const PRIORITY_CACHE = "tisly-pwa-priority-v2511-text-to-3d-prompt";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2511-text-to-3d-prompt";
/* お客様ゾーンの互換トークン
