...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2497-iso3d-reel-solo";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2497-iso3d-reel-solo";
const PRIORITY_CACHE = "tisly-pwa-priority-v2497-iso3d-reel-solo";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2497-iso3d-reel-solo";
/* お客様ゾーンの互換トークン
