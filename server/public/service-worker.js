...
/* AI解析1500px送信ルール強制適用 */
const SW_VERSION = "tisly-pwa-v2414-phase47";
const OFFLINE_CACHE = "tisly-pwa-shell-v2414-phase47";
const PRIORITY_CACHE = "tisly-pwa-priority-v2414-phase47";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2414-phase47";
const ICON_V = "?v=2004";
