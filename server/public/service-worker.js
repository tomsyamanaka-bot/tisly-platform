...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2482-pin-clear-fix";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2482-pin-clear-fix";
const PRIORITY_CACHE = "tisly-pwa-priority-v2482-pin-clear-fix";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2482-pin-clear-fix";
/* お客様ゾーンの互換トークン
