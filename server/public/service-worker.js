...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2467-soc-iso";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2467-soc-iso";
const PRIORITY_CACHE = "tisly-pwa-priority-v2467-soc-iso";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2467-soc-iso";
/* お客様ゾーンの互換トークン
