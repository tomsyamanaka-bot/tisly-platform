...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2496-iso3d-contrast-drum";
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2496-iso3d-contrast-drum";
const PRIORITY_CACHE = "tisly-pwa-priority-v2496-iso3d-contrast-drum";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2496-iso3d-contrast-drum";
/* お客様ゾーンの互換トークン
