...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2427-nastoms-doc-nas";
const OFFLINE_CACHE = "tisly-pwa-shell-v2427-nastoms-doc-nas";
const PRIORITY_CACHE = "tisly-pwa-priority-v2427-nastoms-doc-nas";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2427-nastoms-doc-nas";
const ICON_V = "?v=2004";
