...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2552-toyoshima-instant-relay";
/* 旧世代名は activate で破棄する
 * tisly-pwa-v2551-toyoshima-light-kick-ui
 ...
 * tisly-pwa-v2537-gv-scheme-direct
 ...
 * tisly-pwa-v2501-field-hub-clean
 * tisly-pwa-v2500-dashboard-compact-3d
...
const OFFLINE_CACHE = "tisly-pwa-shell-v2543-itabashi-light-bypass";
const PRIORITY_CACHE = "tisly-pwa-priority-v2543-itabashi-light-bypass";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2543-itabashi-light-bypass";
/* お客様ゾーンの互換トークン
