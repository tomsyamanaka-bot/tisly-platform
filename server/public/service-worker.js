...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2454-rp2350-firmware-zip";
const OFFLINE_CACHE = "tisly-pwa-shell-v2454-rp2350-firmware-zip";
const PRIORITY_CACHE = "tisly-pwa-priority-v2454-rp2350-firmware-zip";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2454-rp2350-firmware-zip";
const ICON_V = "?v=2004";
