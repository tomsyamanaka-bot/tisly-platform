...
const SW_VERSION = "tisly-pwa-v2392-production";
const OFFLINE_CACHE = "tisly-pwa-shell-v2392-production";
const PRIORITY_CACHE = "tisly-pwa-priority-v2392-production";
const ICON_V = "?v=2003";
const SHELL_URLS = [
