...
/* オフライン完全対応 + 音声入力 v1 */
/* ネオン・ダークUI v1 */
const SW_VERSION = "tisly-pwa-v2455-property-delete";
const OFFLINE_CACHE = "tisly-pwa-shell-v2455-property-delete";
const PRIORITY_CACHE = "tisly-pwa-priority-v2455-property-delete";
const FIELD_OPS_CACHE = "tisly-pwa-fieldops-v2455-property-delete";
const ICON_V = "?v=2004";
