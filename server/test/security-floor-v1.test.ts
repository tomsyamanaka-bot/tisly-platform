...
describe("security-floor-v1", () => {
  ...
  it("serves pages CSS keyframes and APIs", async () => {
    ...
    assert.match(html, /security-floor-remote-config-v1\.js\?v=2496/);
    assert.match(html, /security-floor-push-v1\.js\?v=2496/);
    assert.match(html, /security-floor-light-v1\.js\?v=2496/);
    assert.match(html, /security-floor-operator-v1\.js\?v=2496/);
    assert.match(html, /security-floor-iso3d-v1\.js\?v=2496/);
    assert.match(html, /security-floor-v1\.css\?v=2496/);
