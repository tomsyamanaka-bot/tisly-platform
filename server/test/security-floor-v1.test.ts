...
describe("security-floor-v1", () => {
  ...
  it("serves pages CSS keyframes and APIs", async () => {
    ...
    assert.match(css, /rgba\(255,\s*255,\s*255,\s*0\.85\)/);
    ...
    assert.match(html, /security-floor-remote-config-v1\.js\?v=2506/);
    assert.match(html, /security-floor-push-v1\.js\?v=2506/);
    assert.match(html, /security-floor-light-v1\.js\?v=2506/);
    assert.match(html, /security-floor-operator-v1\.js\?v=2506/);
    assert.match(html, /security-floor-iso3d-v1\.js\?v=2506/);
    assert.match(html, /security-floor-v1\.css\?v=2506/);
    assert.match(html, /sf-brand-logo/);
    assert.match(html, /tisly-shield-logo-128\.png/);
    assert.match(html, /icons\/icon-128\.png\?v=2506/);
