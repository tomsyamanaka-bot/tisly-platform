...
describe("security-floor-v1", () => {
  ...
  it("serves pages CSS keyframes and APIs", async () => {
    ...
    assert.match(iso3dJs, /enablePan\s*=\s*true/);
    assert.match(iso3dJs, /screenSpacePanning/);
    assert.match(iso3dJs, /PAN_LIMIT|clampPanTarget/);
    assert.match(iso3dJs, /beginCameraReset|camResetAnim|CAM_RESET_DURATION/);
    ...
    assert.match(toyoshimaJs, /bindToyoshimaLightKickButtons/);
