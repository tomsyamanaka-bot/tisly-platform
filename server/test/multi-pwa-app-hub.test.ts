...
describe("Phase 461-480 multi PWA app hub", () => {
  ...
  it("serves offline fallback and SW v461", async () => {
    ...
    assert.ok(
      ...
      sw.text.includes("tisly-pwa-v2549-customer-auth-detail") ||
      sw.text.includes("tisly-pwa-v2548-toyoshima-2step-flash") ||
      ...
      sw.text.includes("tisly-pwa-v2543-itabashi-light-bypass") ||
      sw.text.includes("tisly-pwa-v2542-security-history-modal") ||
      sw.text.includes("tisly-pwa-v2541-tester-login-hardpass") ||
      sw.text.includes("tisly-pwa-v2540-tester-login-passthrough") ||
      sw.text.includes("tisly-pwa-v2539-tester-login-fix") ||
      sw.text.includes("tisly-pwa-v2538-tester-demo-webview") ||
      sw.text.includes("tisly-pwa-v2537-gv-scheme-direct") ||
      sw.text.includes("tisly-pwa-v2536-gv-iframe-safe") ||
      sw.text.includes("tisly-pwa-v2535-guard-viewer-launch") ||
      ...
      sw.text.includes("tisly-pwa-v2530-customer-fw-ssot") ||
      sw.text.includes("tisly-pwa-v2529-ota-site-bind") ||
      ...
      sw.text.includes("tisly-pwa-v2524-rp-ota-standard") ||
      sw.text.includes("tisly-pwa-v2523-hw-badge-ssot") ||
      sw.text.includes("tisly-pwa-v2522-status-ssot") ||
      sw.text.includes("tisly-pwa-v2521-tester-itabashi-live") ||
      sw.text.includes("tisly-pwa-v2520-tenant-skeleton-hb") ||
      sw.text.includes("tisly-pwa-v2516-comm-health-ssot") ||
      sw.text.includes("tisly-pwa-v2515-customer-daily-mount") ||
