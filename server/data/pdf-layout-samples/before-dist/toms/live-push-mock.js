...
import { broadcastHeartbeat, pushFloorAlertLive, pushProjectDevicesLive, pushProjectNotificationsLive, } from "./live-push-bridge.js";
...
let timer = null;
export function startLiveOperationsMockPush(intervalMs = 12000) {
...
export function stopLiveOperationsMockPush() {
    if (timer) {
        clearInterval(timer);
        timer = null;
    }
