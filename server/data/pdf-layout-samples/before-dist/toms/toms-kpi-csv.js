import { buildTomsKpi } from "./toms-kpi.js";
...
const CUSTOMER_HEADER = "customer_id,customer_name,revenue,gross_profit,uninvoiced,unpaid,maintenance_count,anomaly_count";
export function exportTomsKpiCsv() {
...
export function exportCustomerKpiCsv(customerId) {
    const k = buildTomsKpi();
