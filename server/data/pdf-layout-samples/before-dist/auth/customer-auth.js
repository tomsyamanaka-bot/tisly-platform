...
import { loginAdmin } from "./admin-auth.js";
import { clearCustomerFailedLogins, isCustomerUserLocked, recordCustomerFailedLogin, } from "./customer-login-security.js";
import { logAudit } from "../provisioning/audit-log.js";
export function loginCustomer(customerCode, username, password, meta) {
...
export function loginUnified(customerCode, username, password, meta) {
    if (customerCode)
        return loginCustomer(customerCode, username, password, meta);
...
export function resolveAnySession(token) {
