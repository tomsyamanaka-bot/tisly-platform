...
import { customerSiteBuilderRouter, floorApiRouter, mapApiRouter, siteApiRouter, zoneApiRouter, } from "./api/routes/site-builder.js";
...
export function createApp() {
    ...
    app.get("/business/projects/:projectId/completion-report", (_req, res) => res.sendFile(businessHtml));
    ...
    app.get("/business/projects/:projectId/specification", (_req, res) => res.sendFile(businessHtml));
    ...
    app.use("/uploads/floorplans", express.static(path.join(process.cwd(), "uploads", "floorplans")));
    app.use("/uploads/install_photos", express.static(path.join(process.cwd(), "uploads", "install_photos")));
    app.use("/customer-files", express.static(path.join(process.cwd(), "customer-files")));
    app.use("/uploads/install-photos", express.static(path.join(process.cwd(), "uploads", "install-photos")));
