 ...
 */
export const RC2_PRODUCTION_ROUTES = [
    {
        path: "/app",
        label: "App Hub",
        workflow: "全 PWA 入口",
...
export function buildRc2CheckUrls(baseUrl = "https://tisly.jp", customerCode = "TOMS001") {
...
export function resolveProductionRoutePath(spec) {
