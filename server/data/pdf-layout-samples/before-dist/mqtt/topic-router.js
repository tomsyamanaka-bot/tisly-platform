...
import { parseEspMqttTopic } from "./esp-topic-standard.js";
...
export function mqttPayloadToUnified(parsed, payload) {
...
function inferSourceType(deviceId) {
    const id = deviceId.toLowerCase();
    if (id.includes("esp"))
        return "esp32";
    if (id.includes("rp2350") || id.includes("rp-"))
        return "rp2350";
    if (id.includes("plc"))
        return "plc";
    if (id.startsWith("tv-"))
