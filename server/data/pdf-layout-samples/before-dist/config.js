...
export const config = {
    ...
    get rateLimitProvider() {
        return env("RATE_LIMIT_PROVIDER", "memory");
    },
    redis: {
    ...
    securityAutomation: {
        ...
        get unknownDevicePolicy() {
            ...
            if (p === "unknown_as_away" || p === "unknown_as_home")
                return p;
            return "block_auto_arm";
        },
