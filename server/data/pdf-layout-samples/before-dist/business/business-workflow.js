import { getBusinessProject, getCompletionReport, getEstimate, getInvoice, saveCalendarDraft, saveMailDraft, saveQnapPlan, updateBusinessProject, } from "./business-store.js";
import { assertTransition, normalizeProjectStatus, statusAfterClosed, } from "./business-status.js";
import { createConstructionCalendarDraft, createPaymentCalendarDraft, createSiteSurveyCalendarDraft, } from "./services/googleCalendarService.js";
import { createCompletionMailDraft, createEstimateMailDraft, createInvoiceMailDraft, } from "./services/gmailService.js";
...
function runSideEffects(project, to) {
    const out = {};
    ...
    if (["estimate_created", "completion_report_created", "invoice_created", "paid"].includes(normalized)) {
...
export function transitionProjectStatus(projectId, to) {
    const project = getBusinessProject(projectId);
    if (!project)
        throw new Error("project not found");
    const target = normalizeProjectStatus(String(to));
