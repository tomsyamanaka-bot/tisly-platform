import { formatTomsIssueDate, itemsToTomsLines, TOMS_DEFAULT_STAFF, } from "../toms-document-format.js";
import { TOMS_PDF_STYLES } from "./styles.js";
import { escapeHtml, renderAmountBanner, renderBankBlock, renderNotes, renderPhotoGrid, renderSealPlaceholder, renderTomsDocLayoutHeader, renderTomsLineItemsTable, renderTotals, } from "./shared-blocks.js";
export function buildInvoiceHeader(project, invoice, estimate, opts) {
...
export function renderInvoiceHtml(project, invoice, estimate, opts) {
