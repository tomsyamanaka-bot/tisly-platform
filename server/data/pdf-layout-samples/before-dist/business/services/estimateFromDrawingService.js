...
export function summarizeMaterialsFromDrawing(plan) {
...
export function summarizeRoutesFromDrawing(plan) {
...
export function createEstimateCandidateFromDrawingPlan(plan) {
