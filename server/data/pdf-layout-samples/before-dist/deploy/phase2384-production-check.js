...
export function buildPhase2384ProductionCheck(env = process.env) {
    ...
    const sendChecks = [
        ...
        },
        {
            ...
            status: lastSend.status === "sent"
                ? "GREEN"
                : lastSend.status === "mock"
                    ? "YELLOW"
                    : "RED",
            detail: lastSend.status === "sent"
    ...
    return {
        ...
        operationalReady: criticalOk && base2383.adminPasswordStatus === "GREEN" && gmailSendVerified,
