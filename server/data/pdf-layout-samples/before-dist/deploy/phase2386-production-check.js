...
export function buildPhase2386ProductionCheck(env = process.env) {
    ...
    const gmailTestModalUi = appHubHtml.includes("gmail-auth-modal") &&
    ...
    return {
        ...
        operationalReady: criticalOk && base2385.adminPasswordStatus === "GREEN" && base2385.gmailSendVerified,
