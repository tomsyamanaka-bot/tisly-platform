...
export function buildProductionReadiness(dryRun) {
    ...
    const pwaReady = installAudit.readyCount === installAudit.totalPwa &&
    ...
    const items = [
        {
            ...
            message: marker?.build || distExists
                ? "dist/index.js ビルド済み"
                : "npm run build 未実行",
        },
        {
        ...
        },
        {
            ...
            status: dryRun.isProductionUrl && urlAudit.publicFacingClean ? "pass" : "fail",
