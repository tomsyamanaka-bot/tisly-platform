...
export function buildPhase2300ProductionCheck() {
    ...
    const checks = [
        ...
        },
        {
            ...
            ok: recovery.includes("listShellyRecoveryHistory") &&
        ...
        },
        {
            ...
            ok: qnapConnector.includes("QnapPayloadType") &&
    ...
    const criticalOk = checks.filter((c) => ["mqtt-real-subscribe", "shelly-recovery-api", "email-provider", "qnap-connector"].includes(c.id)).every((c) => c.ok);
    return {
        phase: "2251-2300",
