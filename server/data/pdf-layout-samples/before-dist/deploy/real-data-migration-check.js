...
export function buildRealDataMigrationCheck() {
    ...
    const appTs = fs.existsSync(path.join(serverSrcDir, "app.ts"))
        ...
        : "";
    const installPhotosTs = fs.existsSync(path.join(serverSrcDir, "installer", "install-photos.ts"))
        ? fs.readFileSync(path.join(serverSrcDir, "installer", "install-photos.ts"), "utf8")
        : "";
    const maintNotesTs = fs.existsSync(path.join(serverSrcDir, "maintenance", "maintenance-inspection-notes.ts"))
    ...
    const checks = [
        ...
        },
        {
            ...
            ok: maintenanceJs.includes("/api/maintenance/inspection") &&
        ...
        },
        {
            ...
            ok: installPhotosTs.includes("customer-files") &&
        ...
        },
        {
            ...
            ok: portalJs.includes("fetchPortalEvents") &&
        ...
        },
        {
            ...
            ok: shellJs.includes("tisly-mock-real-banner") &&
