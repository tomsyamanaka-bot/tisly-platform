...
export function buildPhase2350ProductionCheck() {
    ...
    const checks = [
        ...
        },
        {
            id: "gmail-send-logs",
            label: "Gmail 送信ログ DB",
            ok: gmailLog.includes("logGmailSend") &&
        ...
        },
        {
            ...
            ok: notificationsRoute.includes("gmailMode") &&
        ...
        },
        {
            ...
            ok: envExample.includes("SMTP_HOST") &&
    ...
    const criticalOk = checks
        .filter((c) => ["smtp-gmail-provider", "notification-test-email", "notification-stats-gmail", "gmail-send-logs"].includes(c.id))
        .every((c) => c.ok);
    return {
        phase: "2301-2350",
