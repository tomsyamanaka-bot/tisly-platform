 ...
 */
import { createMaintenanceCase, getMaintenanceCase, listMaintenanceCases, updateMaintenanceCase, listRecoveryHistoryForCustomer, } from "../maintenance/maintenance-store.js";
...
export function completeMaintenanceTicket(caseId, notes) {
    return updateMaintenanceCase(caseId, { status: "resolved", notes });
}
export function getCustomerMaintenanceSummary(customerCode) {
