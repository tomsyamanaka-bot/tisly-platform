...
import { getSwitchBotBridgeWorkerState, pollSwitchBotAndBridge, } from "../services/switchBotSecurityBridge.js";
let intervalHandle = null;
let ticking = false;
export async function runSwitchBotBridgeWorkerTick() {
    if (ticking) {
...
export function startSwitchBotBridgeWorker() {
    if (intervalHandle)
        return;
...
export function stopSwitchBotBridgeWorker() {
    if (intervalHandle) {
