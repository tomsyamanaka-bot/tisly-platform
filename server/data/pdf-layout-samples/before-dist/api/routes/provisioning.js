...
import { buildQrSvg, getDeviceQr, provisionDevice, } from "../../provisioning/device-provisioner.js";
import { listAuditLogs } from "../../provisioning/audit-log.js";
export const provisioningRouter = Router();
provisioningRouter.post("/devices", (req, res) => {
    const { siteId, zoneId, deviceType, platform, label, tenantId, actorId, actorLabel } = req.body;
    if (!siteId) {
