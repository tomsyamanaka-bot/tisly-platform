...
import { ensureDemoKit, getDemoFloorMapStatus, getDemoPackStatus, hasDemoTimelineSeed, listDemoNotificationKinds, resetDemoKit, runDemoAiEstimateFlow, triggerDemoNotification, exportDemoKpiCsv, estimateDispatchReductionJpy, buildDemoEstimateHtml, getDemoEstimateMeta, listDemoEstimateTypes, getDemoResetSchedule, setDemoResetSchedule, listDemoResetScheduleModes, runDemoShellyReboot, getDemoFloorPreview, getProRemoteLiveFloorPreview, getDeviceMode, setDeviceMode, DEVICE_MODES, getDeviceAdapterStatus, getDeviceRegistry, listShellyBridgeConfigs, upsertShellyBridgeConfig, pollShellyDevices, getEspHeartbeatKpi, listDemoPackages, launchDemoPackage, calculateRoiV2, startDemoMovie, stopDemoMovie, getDemoMovieStatus, DEMO_PACKAGE_TYPES, getSalesLiveBadge, getSalesShellyEnvBadge, broadcastSalesDemoEvent, } from "../../demo-kit/index.js";
...
demoKitRouter.put("/device-mode", (req, res) => {
    const mode = String(req.body?.deviceMode ?? req.body?.mode);
