...
import { createMaintenanceCase, listMaintenanceCases, getMaintenanceCase, updateMaintenanceCase, deleteMaintenanceCase, listRecoveryHistoryForCustomer, } from "../../maintenance/maintenance-store.js";
...
import { createMaintenanceReport, createMaintenanceSchedule, listMaintenanceSchedules, listMaintenanceReports, } from "../../maintenance/maintenance-schedule.js";
import { getMaintenanceInspectionNote, saveMaintenanceInspectionNote, } from "../../maintenance/maintenance-inspection-notes.js";
export const maintenanceProductionRouter = Router();
const maintAuth = [requireAuth("maintenance")];
function assertMaintenanceRole(req, res) {
...
function resolveCustomerCode(req, code) {
...
maintenanceProductionRouter.post("/from-survey/:projectId", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    try {
...
maintenanceProductionRouter.get("/cases", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customerCode = req.query.customerCode;
    res.json({ cases: listMaintenanceCases(customerCode) });
});
maintenanceProductionRouter.post("/cases", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const body = req.body;
...
maintenanceProductionRouter.get("/cases/:caseId", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
...
maintenanceProductionRouter.patch("/cases/:caseId", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
...
maintenanceProductionRouter.delete("/cases/:caseId", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
...
maintenanceProductionRouter.get("/recovery-history/:customerCode", ...maintAuth, requireTenantMatch("customerCode"), (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
...
maintenanceProductionRouter.get("/shelly/:customerCode", ...maintAuth, requireTenantMatch("customerCode"), (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customer = resolveCustomerCode(req, String(req.params.customerCode));
    if (!customer) {
...
maintenanceProductionRouter.get("/inspection/:customerCode", ...maintAuth, requireTenantMatch("customerCode"), (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customer = resolveCustomerCode(req, String(req.params.customerCode));
    if (!customer) {
...
maintenanceProductionRouter.post("/inspection", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const body = req.body;
    if (!body.customerCode) {
...
maintenanceProductionRouter.get("/schedule", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customerCode = req.query.customerCode;
...
maintenanceProductionRouter.post("/schedule", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const body = req.body;
...
maintenanceProductionRouter.post("/report", ...maintAuth, (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const body = req.body;
    if (!body.customerCode) {
...
maintenanceProductionRouter.get("/reports/:customerCode", ...maintAuth, requireTenantMatch("customerCode"), (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customer = resolveCustomerCode(req, String(req.params.customerCode));
    if (!customer) {
...
maintenanceProductionRouter.post("/shelly/:customerCode/:deviceId/reboot", ...maintAuth, requireTenantMatch("customerCode"), (req, res) => {
    if (!assertMaintenanceRole(req, res))
        return;
    const customer = resolveCustomerCode(req, String(req.params.customerCode));
    if (!customer) {
