...
const OLD_ICON_SRC_RE = /"src"\s*:\s*"\/icons\/icon-(?:64|128|192|256|384|512)\.png"(?!\?v=)/;
...
export function buildVpsPwaIconUpdateBlock() {
    return [
        "cd /opt/tisly",
...
export function buildPwaIconCheck() {
    ...
    const checks = ICON_CHECK_URLS.map((spec) => {
