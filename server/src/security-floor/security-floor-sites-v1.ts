...
function ensureToyoshimaSecuritySiteV1(): void {
  ...
  const site: SecuritySiteV1 = {
    ...
    sensors: [
      {
        ...
        roomId: "tm-out-main",
        kind: "mmwave",
        label: "母屋 赤外線ビーム DI1（遠・外周）",
        customerLabel: "母屋 外周センサー",
        x: 20,
        y: 32,
        state: "normal",
      ...
      },
      {
        ...
        roomId: "tm-out-main",
        kind: "mmwave",
        label: "母屋 赤外線ビーム DI2（近・アプローチ）",
        customerLabel: "母屋 建物至近センサー",
        x: 32,
        y: 38,
        state: "normal",
      ...
      },
      {
        ...
        roomId: "tm-out-main",
        kind: "panel",
        label: "母屋 100V フラッシュ (DO3)",
        customerLabel: "母屋 フラッシュライト",
        x: 24,
        y: 42,
        state: "normal",
    ...
    notes: [
      ...
      "母屋 2STEP: DI1=DO1 / DI2=DO1+DO2+DO3フラッシュ",
    ],
    lightingOn: 0,
    lightingTotal: 5,
    energyKw: 1.45,
