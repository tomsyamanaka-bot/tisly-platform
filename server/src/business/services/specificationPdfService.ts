...
export function buildSpecificationPdfLines(
  project: BusinessProject,
  plan: DrawingPlan,
  doc: Pick<SpecificationDocument, "title" | "overview" | "workSummary" | "notes">
): string[] {
...
export function generateSpecificationPdf(
  project: BusinessProject,
  plan: DrawingPlan,
  doc: Pick<SpecificationDocument, "title" | "overview" | "workSummary" | "notes">
): { pdfPath: string; qnapPath: string } {
...
export function createSpecificationDocumentFromPlan(
  project: BusinessProject,
  plan: DrawingPlan,
  input?: { title?: string; overview?: string; workSummary?: string; notes?: string }
