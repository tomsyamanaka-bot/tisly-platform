...
function serverFileExists(rel: string): boolean {
...
export function buildFieldOperationsAudit(): FieldOperationsAudit {
  const surveyReady =
    fileExists("survey.html") &&
    fileExists("js/survey.js") &&
    fileContains("survey.html", "btn-survey-new-case") &&
    fileContains("survey.html", "survey-category-bar");

  const projectReady =
    fileExists("project-dashboard.html") &&
  ...
  let verdict: FieldVerdict = "FIELD_NOT_READY";
