...
export function sanitizeHomeCustomerDashboardV1(
  ...
  return {
    ...
    intercom: {
      ...
      modelId: intercom.modelId,
      modelLabel: intercom.modelLabel,
      micMuted: intercom.micMuted,
      speakerVolume: intercom.speakerVolume,
      recording: intercom.recording,
      answerDeepLink: intercom.answerDeepLink,
      statusBadge: intercom.statusBadge,
      statusBadgeLabel: intercom.statusBadgeLabel,
      previewMode: intercom.previewMode,
      lastSnapshotAt: intercom.lastSnapshotAt,
    },
