...
import {
  completeDeploymentChecklistItem,
  getDeploymentChecklistRC2,
} from "../../deployment-kit/deployment-checklist-rc2.js";

export const deploymentRc2Router = Router();

const installerAuth = [requireAuth("installer")] as const;

deploymentRc2Router.get("/checklist/:projectId", ...installerAuth, (req: AuthedRequest, res) => {
...
deploymentRc2Router.post(
  "/checklist/:projectId/item/:itemId/complete",
  ...installerAuth,
  (req: AuthedRequest, res) => {
    ...
    const item = completeDeploymentChecklistItem(
